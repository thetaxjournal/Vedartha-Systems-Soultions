...
import { Branch, Address } from '../types';
import { Edit2, Plus, Trash2, MapPin, Building2, Globe, FileText, X, Save } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {showModal && editingBranch && (
        <div className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-6 backdrop-blur-xl animate-in zoom-in-95 duration-300">
          <div className="bg-white w-full max-w-5xl rounded-[48px] shadow-[0_48px_160px_-16px_rgba(0,0,0,0.6)] flex flex-col border border-white/20 overflow-hidden">
            ...
            <div className="p-14 grid grid-cols-2 gap-20 bg-white">
              ...
              <div className="space-y-8">
                 <h4 className="text-[12px] font-black text-amber-600 uppercase tracking-[0.2em] mb-8 flex items-center border-b border-amber-50 pb-4"><FileText size={18} className="mr-4" /> Billing & Logistics Parameters</h4>
